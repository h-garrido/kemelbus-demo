        ...
        <div className="bg-white rounded-[3rem] shadow-xl border border-emerald-100 overflow-hidden">
          ...
          <div className="p-8 md:p-12 grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex flex-col justify-center space-y-8">
              <div className="bg-emerald-50 p-6 rounded-2xl border border-emerald-200 min-h-[140px] flex flex-col justify-center">
                {selectedSeat ? (
                  <>
              ...
              <button
                ...
                className="w-full py-4 bg-emerald-600 text-white rounded-xl font-black disabled:bg-gray-200 disabled:text-gray-400"
              >
                AGREGAR AL VIAJE
              </button>
            </div>

      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 text-center md:text-left">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm font-medium">
              <li>Traslado de Personal</li>
              <li>Turismo y Giras</li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><Link href="#" className="hover:text-white transition">Nuestra Política de Seguridad</Link></li>
              <li><Link href="#" className="hover:text-white transition">Trabaja como Conductor</Link></li>
            </ul>
          </div>
        ...
        <div className="mt-16 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6 text-[10px] text-emerald-500 font-bold uppercase tracking-widest">
          ...
          <div className="flex gap-8">
            <Facebook size={20} className="hover:text-white transition cursor-pointer" />
